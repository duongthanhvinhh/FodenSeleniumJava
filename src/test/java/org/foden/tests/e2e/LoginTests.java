...
public class LoginTests extends BaseSteps {
    ...
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify logging into the Application using valid credentials", groups = {"FAS-44", "FAS-11", TestGroups.Id.SMOKE})
    @Story("FAS-44")
    ...
    @Epic("FAS-7: Feature: Authentication - Authorization")
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify logging into the Application using invalid credentials", groups = {"FAS-45", "FAS-11", TestGroups.Id.SMOKE})
    @Story("FAS-45")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Epic("FAS-7: Feature: Authentication - Authorization")
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify 'Forgotten Password' link is available in the Login page and is working", groups = {"FAS-47", "FAS-11", TestGroups.Id.SMOKE})
    @Story("FAS-47")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Epic("FAS-7: Feature: Authentication - Authorization")
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify E-Mail Address and Password text fields in the Login page have the place holder text ", groups = {"FAS-48", "FAS-11", TestGroups.Id.REGRESSION})
    @Story("FAS-48")
    @Severity(SeverityLevel.NORMAL)
    ...
    @Epic("FAS-7: Feature: Authentication - Authorization")
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify the different ways of navigating to the Login page", groups = {"FAS-52", "FAS-11", TestGroups.Id.REGRESSION})
    @Story("FAS-52")
    @Severity(SeverityLevel.NORMAL)
    @Description("Verify the different ways of navigating to the Login page")
    @Owner("Foden Duong")
    public void verifyAllWaysToNavigateToLoginPage(){
        SoftAssert softAssert = new SoftAssert();
        initializeWebDriver();
        LoginPage loginPage = LoginPage.getInstance();
    ...
    @Epic("FAS-7: Feature: Authentication - Authorization")
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify the number of unsuccessful login attempts", groups = {"FAS-59", "FAS-11", TestGroups.Id.SMOKE})
    @Story("FAS-59")
    @Severity(SeverityLevel.NORMAL)
    @Description("Verify the number of unsuccessful login attempts")
    @Owner("Foden Duong")
    ...
    @Epic("FAS-7: Feature: Authentication - Authorization")
    @Feature("FAS-11: Develop scripts for scenarios Login, Logout")
    @Test(description = "Verify the Breadcrumb, Page Heading, Page Title and Page URL of Login page", groups = {"FAS-53", "FAS-11", TestGroups.Id.SMOKE})
    @Story("FAS-53")
    @Severity(SeverityLevel.NORMAL)
    @Description("Verify the Breadcrumb, Page Heading, Page Title and Page URL of Login page")
    @Owner("Foden Duong")
